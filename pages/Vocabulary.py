...
with tab1:
  ...
  url = "https://github.com/misong333/streamlit25/raw/main/data/word_frequency%202.csv"
  df = pd.read_csv(url)
...
with tab3:
    ...
    # Load CSV
    url = "https://github.com/misong333/streamlit25/raw/main/data/word_frequency%202.csv"  # Replace this!
    df = pd.read_csv(url)
